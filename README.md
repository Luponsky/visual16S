...
Before install the visual16S, there are some packages needed to be
...
You need to run install from the parent working directory that contains
the visual16S
folder.
...
First use the track\_reads\_dada2 function to check reads drop
associated with every step in DADA2.

Note:

You can plot reads track in either absolute abundance or relative
abundance.

If the sample size is too large to show on legend, set legend\_position
to “none”.
...
Use plot\_stacked\_bar function to plot the taxonomy level abundance in
every sample. You can change the ‘level’ argument to plot abundance in
different level, or change the ‘feature’ to choose different feature you
want to show in x-axis.
...
![](README_files/figure-gfm/Stacked%20barplot%201-1.png)<!-- -->
...
![](README_files/figure-gfm/Stacked%20barplot%202-1.png)<!-- -->
...
![](README_files/figure-gfm/Stacked%20barplot%203-1.png)<!-- -->
...
![](README_files/figure-gfm/Stacked%20barplot%204-1.png)<!-- -->
...
![](README_files/figure-gfm/Stacked%20barplot%205-1.png)<!-- -->
...
![](README_files/figure-gfm/Chao1-1.png)<!-- -->

# Beta diversity

Use plot\_beta\_diversity to plot beta diversity. Change ‘method’ to
...
![](README_files/figure-gfm/Bray-Curtis-1.png)<!-- -->
...
```
    ...
    ## 1 OTU154       22.40152 2.806170e-11
    ## 4 OTU164       21.85581 5.133859e-05
    ## 5 OTU312       20.74025 1.658810e-04
    ## 8 OTU228       19.48117 4.637397e-04
    ## 6 OTU331      -18.93625 1.699347e-04
    ## 7 OTU282      -20.06961 2.784319e-04
    ## 3 OTU109      -22.19975 1.731359e-06
    ## 2 OTU152      -25.34458 1.312529e-08

![](README_files/figure-gfm/log2fc%201-1.png)<!-- -->

Choose log2fc reference and treatment by ‘reference’ and ‘treatment’
parameters. Both should be one of the levels in ‘feature’.
...
```
    ...
    ##       OTU log2FoldChange         padj
    ## 5  OTU228       22.02247 1.956391e-05
    ## 6  OTU342       20.01652 1.949446e-04
    ## 1  OTU154       19.98696 6.976725e-09
    ## 7  OTU349       19.72481 2.352799e-04
    ## 8  OTU312       19.59086 2.405934e-04
    ## 9  OTU164       18.40404 8.190801e-04
    ## 11 OTU138      -10.69069 1.397755e-02
    ## 10  OTU32      -13.83664 4.581684e-03
    ## 4  OTU355      -22.15072 1.691641e-05
    ## 3  OTU131      -23.65191 3.727929e-06
    ## 2   OTU36      -27.48653 1.053817e-08

![](README_files/figure-gfm/log2fc%202-1.png)<!-- -->
